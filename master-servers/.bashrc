#
# Copyright (C) 2004-2016 David Jia Wei Li
#
# .bashrc Configuration for Server Users
#
...
# Custom Prompt
export PS1='\[\033[1;33m\](\[\033[0;37m\]\u\[\033[1;33m\]@\h\[\033[1;33m\]:\[\033[1;36m\]\w\[\033[1;33m\])\[\033[1;36m\]\$ \[\033[0;37m\]'
export PS2='-->'

# Override for root
if $_isroot; then
    export PS1='\[\033[1;34m\](\[\033[1;34m\]\u\[\033[1;31m\]@\h\[\033[1;31m\]:\[\033[1;36m\]\w\[\033[1;34m\])\[\033[1;36m\]\$ \[\033[0;37m\]'
    export PS2='#->'
fi
...
#
# Copyright Petar Marinov
# (Shamelessly stolen from the CygWin .bashrc)
#
...
# Common Aliases
#
# Note: Not using separate aliases file in order to simplify deployment via
#       symlinks
#
...
#
# DLP Notes Implementation
#
# Add way to save small notes about the current directory
#
...
notes()
{
    ...
    # Echo a nice message about the directory
    if [ -f "$NOTELOC".dlp_cdnotes ]; then
      cat "$NOTELOC".dlp_cdnotes
      echo
    fi

    if [ -f "$NOTELOC".dlp_dirnotes ]; then
      cat "$NOTELOC".dlp_dirnotes
    else
      echo "No Notes Found"
    fi  
}

alias vinotes='vim .dlp_cdnotes'
alias vidirnotes='vim .dlp_dirnotes'
